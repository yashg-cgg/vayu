...
namespace Vayu.MarketLibraryErcot
{
    public class BindingConstraints
    {
        ...
        public ERCOTNodalService.RequestMessage CreateRequestMessage(ERCOTNodalService.RequestTypeMarketType myMarketType, DateTime operatingDate)
        {
            ERCOTNodalService.HeaderType myHeader = new ERCOTNodalService.HeaderType();
        ...
        public void Download()
        {
            try
            {
                ...
                */
                ...
                Vayu.MarketLibraryErcot.AsymmetricCustomBinding acb = new Vayu.MarketLibraryErcot.AsymmetricCustomBinding();
                CustomBinding myBinding = acb.CreateAsymmetricBinding();

                Vayu.MarketLibraryErcot.ErcotNodalClient ercotClient = new Vayu.MarketLibraryErcot.ErcotNodalClient();
                Vayu.MarketLibraryErcot.ERCOTNodalService.OperationsClient operationsClient = ercotClient.CreateErcotOperationsClient(myBinding, 0);

                Vayu.MarketLibraryErcot.BindingConstraints bindingConstraints = new Vayu.MarketLibraryErcot.BindingConstraints();
                Vayu.MarketLibraryErcot.ERCOTNodalService.RequestMessage reqMessage = bindingConstraints.CreateRequestMessage(Vayu.MarketLibraryErcot.ERCOTNodalService.RequestTypeMarketType.DAM, DateTime.Parse("2012-03-01T00:00:00-05:00"));
                Vayu.MarketLibraryErcot.ERCOTNodalService.ResponseMessage respMessage = new Vayu.MarketLibraryErcot.ERCOTNodalService.ResponseMessage();
