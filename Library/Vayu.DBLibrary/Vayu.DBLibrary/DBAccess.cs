...
namespace Vayu.DBLibrary
{
    ...
    public class DBAccess
    {
        ...
        private static SqlCommand cmdSelectErcotExternalBids;
        /// <summary>
        ...
        private static SqlCommand cmdErcotSelectUptoUnCleared;
        ...
        private static SqlCommand cmdDeleteFtrBidAnnualErcot;
        private static SqlCommand cmdInsertFtrBidCommandErcot;
        private static SqlCommand cmdInsertFtrBidAnnualCommandErcot;
        #endregion
        ...
        /// </summary>
        private static Dictionary<int, PricingNode> dictPJMNodeHash = new Dictionary<int, PricingNode>();
        private static Dictionary<int, PricingNode> dictErcotNodeHash = new Dictionary<int, PricingNode>();
        /// <summary>
        ...
        /// </summary>
        private static Dictionary<int, int> dictNodeExtHash = new Dictionary<int, int>();
        /// <summary>
        ...
        private static void LoadDB()
        {
            try
            {
                ...
                cmdSelectAllNodes.Connection = VayuConnection;
                //
                ...
                cmdSelectAllErcotNodes.Connection = VayuConnection;
                //
                ...
                cmdSelectVirtualForfeiture.Connection = VayuConnection;
                //
                ...
                cmdSelectNameDateRange.Connection = VayuConnection;
                //
                ...
                cmdSelectDateDateRange.Connection = VayuConnection;
                //
                ...
                cmdSelectCurrentBids.Connection = VayuConnection;
                //
                ...
                cmdSelectPortfolioCurrentBids.Connection = VayuConnection;
                //
                ...
                cmdSelectCurrentUptos.Connection = VayuConnection;
                //
                ...
                cmdSelectPortfolioSourceUptos.Connection = VayuConnection;
                //
                ...
                cmdSelectPortfolioSinkUptos.Connection = VayuConnection;
                //
                ...
                cmdSelectPJMConstraintSensitivity.Connection = VayuConnection;
                //                
                ...
                cmdSelectMISOConstraintSensitivity.Connection = VayuConnection;
                //
                ...
                cmdSelectContingencySensitivity.Connection = VayuConnection;
                //
                ...
                cmdSelectMISOContingencySensitivity.Connection = VayuConnection;
                //
                cmdSelectSensitivity = new SqlCommand();
                cmdSelectSensitivity.CommandText = "select nodekey, sensitivity from RTMasterConstraint r join RTMasterVector_new v on v.ConstraintRTNum = r.ConstraintRTNum where r.MonitoredText = @constraintname and @contingency = r.ContingencyText and sensitivity <> 0 order by sensitivity";
                ...
                cmdSelectSensitivity.Connection = VayuConnection;
                //
                ...
                cmdSelectMISOSensitivity.Connection = VayuConnection;
                //
                ...
                cmdSelectPortfolioName.Connection = VayuConnection;
                //
                ...
                cmdSelectPortfolioFileVirtualBidsByUser.Connection = VayuConnection;
                //
                ...
                cmdSelectPortfolioFileVirtualBids.Connection = VayuConnection;
                //                
                ...
                cmdSelectPortfolio.Connection = VayuConnection;
                ...
                cmdSelectFTRPortfolio.Connection = VayuConnection;
                ...
                cmdSelectPortfolioFromAccount.Connection = VayuConnection;
                //
                ...
                cmdSelectPortfolioInErcotEESBids.Connection = VayuConnection;//' //VayuDBConnection;
                //
                cmdSelectMaxBidIdCommand = new SqlCommand();
                cmdSelectMaxBidIdCommand.CommandText = "select max(bidid) from VirtualBids";
                cmdSelectMaxBidIdCommand.Connection = VayuConnection;
                //
                ...
                cmdSelectPortfolioInEESBids.Connection = VayuConnection;

                //
                cmdSelectPortfolioInFTRBids = new SqlCommand();
                cmdSelectPortfolioInFTRBids.CommandText = "select COUNT(*) from CRRBids where PortfolioKey=@PortfolioKey and Auction = @Auction";
                ...
                cmdSelectPortfolioInFTRBids.Connection = VayuConnection;
                ...
                cmdSelectPortfolioInVirtualBids.Connection = VayuConnection;
                //
                ...
                cmdSelectPortfolioInVirtualBidsHolder.Connection = VayuConnection;
                //
                ...
                cmdSelectErcotEESBids.Connection = VayuConnection;

                cmdSelectErcotExternalBids = new SqlCommand();
                cmdSelectErcotExternalBids.CommandText = "select SourceKey, SinkKey, MW, Price, DeliveryDate, 'Valid', BidID, '' from Vayu..DAM60DAYPTPBIDS where " +
                                    "  DeliveryDate > @start and DeliveryDate<= @end and ParticipantID = @portfoliokey order by SourceKey, SinkKey, DeliveryDate";
                cmdSelectErcotExternalBids.Parameters.AddWithValue("@start", "EndMarketDateTime");
                cmdSelectErcotExternalBids.Parameters.AddWithValue("@end", "EndMarketDateTime");
                cmdSelectErcotExternalBids.Parameters.AddWithValue("@portfoliokey", "PortfolioKey");
                cmdSelectErcotExternalBids.Connection = VayuConnection;
                ...
                cmdSelectMisoVirtualBids.Connection = VayuConnection;
                //
                ...
                cmdSelectVirtualBids.Connection = VayuConnection;
                //
                ...
                cmdSelectVirtualBidsHolder.Connection = VayuConnection;
                //
                ...
                cmdSelectNodeFromExternal.Connection = VayuConnection;
                //
                ...
                cmdSelectLoad.Connection = VayuConnection;
                //
                ...
                cmdSelectLoadForecast.Connection = VayuConnection;
                //
                ...
                cmdSelectLoadRth.Connection = VayuConnection;
                //
                ...
                cmdSelectWeather.Connection = VayuConnection;
                //
                ...
                cmdSelectWeatherForecast.Connection = VayuConnection;
                //
                ...
                cmdInsertEESBids.Connection = VayuConnection;
                //
                ...
                cmdInsertErcotEESBids.Parameters.AddWithValue("@SubmittedDateTime", "SubmittedDateTime");
                cmdInsertErcotEESBids.Parameters.AddWithValue("@comments", "comments");
                cmdInsertErcotEESBids.Connection = VayuConnection;
                ...
                cmdDeleteEESBidsCommand.Connection = VayuConnection;
                //
                ...
                cmdDeleteEESBidsById.Connection = VayuConnection;
                //
                ...
                cmdDeleteFileVirtualBids.Connection = VayuConnection;
                //
                ...
                cmdDeleteErcotEESBidsCommand.Connection = VayuConnection;
                //
                ...
                cmdDeleteErcotEESBidsById.Connection = VayuConnection;
                //
                ...
                cmdSelectSourceSink.Connection = VayuConnection;
                //
                ...
                cmdSelectSource.Connection = VayuConnection;
                ...
                cmdSelectSinkCommand.Connection = VayuConnection;
                //
                ...
                cmdSelectSourceSinkNode.Connection = VayuConnection;
                //
                cmdSelectVirtualNodes = VayuConnection.CreateCommand();
                ...
                cmdSelectWeatherCities.Connection = VayuConnection;
                //
                ...
                cmdInsertVirtualBids.Connection = VayuConnection;
                //
                ...
                cmdDeleteVirtualBids.Connection = VayuConnection;
                //
                ...
                cmdDeleteValidVirtualBids.Connection = VayuConnection;
                //
                cmdDeleteVirtualBidsForUpdate = VayuConnection.CreateCommand();
                ...
                cmdSelectLoadDiffList.Connection = VayuConnection;
                //
                ...
                cmdSelectAllPath.Connection = VayuConnection;
                //
                ...
                cmdInsertLoadThreshold.Connection = VayuConnection;
                //
                ...
                cmdDeleteLoadThreshold.Connection = VayuConnection;
                //
                ...
                cmdSelectLoadThreshold.Connection = VayuConnection;
                //
                ...
                cmdUpdateSubmitVirtualPortfolio.Connection = VayuConnection;
                //
                ...
                cmsSelectftrBidspeakoffpeak.Connection = VayuConnection;
                //
                ...
                cmsSelectftrBidspeakoffpeakErcot.Connection = VayuConnection;


                cmsSelectftrPortfilio = new SqlCommand();
                cmsSelectftrPortfilio.CommandText = "Select STRIP,PORTFOLIO_ID from PORTFOLIO where HUB=@HUB and PRODUCT='CRR'";
                cmsSelectftrPortfilio.Parameters.AddWithValue("@HUB", "HUB");
                cmsSelectftrPortfilio.Connection = VayuConnection;
                //
                ...
                cmdInsertPJMFtrBidCommand.Connection = VayuConnection;
                ...
                cmdInsertFtrBidCommandErcot.Connection = VayuConnection;


                ///CRR ANNUAL
                cmdInsertFtrBidAnnualCommandErcot = new SqlCommand();
                cmdInsertFtrBidAnnualCommandErcot.CommandText = "insert CRRBidsAnnual (Participant,Month,Auction,startdate,enddate,ClassType,TradeType,HedgeType,MW1,Price1,MW2,Price2,MW3,Price3,MW4," +
                    "Price4,MW5,Price5,MW6,Price6,PortfolioKey,MarketKey,Source,Sink,status) " +
                    " values(@Participant, @month, @auction,@startdate,@enddate, @classtype, @tradetype, @hedgetype," +
                    "@mw1,@price1,@mw2,@price2,@mw3,@price3,@mw4,@price4,@mw5,@price5,@mw6,@price6,@portfoliokey,@MarketKey," +
                                                     "@source,@sink,'IMPORTED')";
                //cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@PeriodKey", "PeriodKey");
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@Participant", "Participant");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@MarketKey", "MarketKey");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@month", "month");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@auction", "auction");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@startdate", "startdate");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@enddate", "enddate");//
                //cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@periodtype", "periodtype");
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@classtype", "classtype");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@tradetype", "tradetype");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@hedgetype", "hedgetype");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@mw1", "mw1");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@price1", "price1");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@mw2", "mw2");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@price2", "price2");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@mw3", "mw3");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@price3", "price3");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@mw4", "mw4");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@price4", "price4");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@mw5", "mw5");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@price5", "price5");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@mw6", "mw6");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@price6", "price6");//
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@portfoliokey", "portfiliokey");//
                //cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@periodhours", "periodhours");
                //cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@periodname", "periodname");
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@source", "source");//
                //cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@sourceextid", "sourceextid");
                cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@sink", "sink");//
                //cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@sinkextid", "sinkextid");
                //cmdInsertFtrBidAnnualCommandErcot.Parameters.AddWithValue("@TcrId", "TcrId");
                cmdInsertFtrBidAnnualCommandErcot.Connection = VayuConnection;
                ...
                cmdDeleteFtrBid.Connection = VayuConnection;
                ...
                cmdDeleteFtrBidErcot.Connection = VayuConnection;

                //CRR ANNUAL
                cmdDeleteFtrBidAnnualErcot = new SqlCommand();
                cmdDeleteFtrBidAnnualErcot.CommandText = "delete CRRBidsAnnual where auction = @auction and portfoliokey = @portfoliokey and ( status <> 'valid' or Status  is null)";
                cmdDeleteFtrBidAnnualErcot.Parameters.AddWithValue("@auction", "auction");
                cmdDeleteFtrBidAnnualErcot.Parameters.AddWithValue("@portfoliokey", "portfiliokey");
                cmdDeleteFtrBidAnnualErcot.Connection = VayuConnection;

                //
                cmdSelectNodeType = new SqlCommand();
                cmdSelectNodeType.CommandText = "select nodetypekey, label from nodetype";
                cmdSelectNodeType.Connection = VayuConnection;
                //
                ...
                cmdSelectCoordinate.Connection = VayuConnection;
                //
                ...
                cmdInsertVirtualBidsHolder.Connection = VayuConnection;
                //
                ...
                cmdSelectPjmRtConstraintNumbers.Connection = VayuConnection;
                //
                ...
                cmdSelectSimilarLoadDay.Connection = VayuConnection;
                //
                ...
                cmdSelectRiskConstraints.Connection = VayuConnection;
                //
                ...
                cmdSelectVirtualCleared.Connection = VayuConnection;
                //
                ...
                cmdSelectUptoCleared.Connection = VayuConnection;
                //
                //Ercot
                ...
                cmdSelectErcotRTFamilies.Connection = VayuConnection;
                ...
                cmdSelectErcotDAFamilies.Connection = VayuConnection;
                ...
                cmdErcotSelectUptoCleared.Connection = VayuConnection;

                cmdErcotSelectUptoUnCleared = new SqlCommand();
                cmdErcotSelectUptoUnCleared.CommandText = "select a.SourceNodeKey,a.RequestedMW,a.EndMarketDateTime,a.SinkNodeKey from ErcotPTPBids a left join ClearedEES b on a.PortfolioKey= b.PortfolioKey and a.ScheduleID=b.BidID and a.EndMarketDateTime = b.MarketDateTime where b.MarketDateTime Is Null and a.EndMarketDateTime >= @startdate and a.EndMarketDateTime <  @enddate and a.PortfolioKey = @portfoliokey";
                cmdErcotSelectUptoUnCleared.Parameters.AddWithValue("@portfoliokey", "portfoliokey");
                cmdErcotSelectUptoUnCleared.Parameters.AddWithValue("@startdate", "startdate");
                cmdErcotSelectUptoUnCleared.Parameters.AddWithValue("@enddate", "enddate");
                cmdErcotSelectUptoUnCleared.Connection = VayuConnection;
                ...
                cmdErcotExternalSelectUptoCleared.Connection = VayuConnection;
                //
                ...
                cmdSelectMW.Connection = VayuConnection;
                //
                ...
                cmdSelectPnlFee.Connection = VayuConnection;
                //
                ...
                cmdSelectLastFee.Connection = VayuConnection;
                //
                ...
                cmdDeleteEESBids.Connection = VayuConnection;
                //
                ...
                cmdDeleteErcotEESBids.Connection = VayuConnection;
                //
                //
                ...
                cmdSelectAccountByUser.Connection = VayuConnection;
                //
                ...
                cmdSelectAccount.Connection = VayuConnection;
                //
                ...
                cmdSelectPortfolioCount.Connection = VayuConnection;
                //
                ...
                cmdSelectPortfolioClearedBids.Connection = VayuConnection;
                ...
                cmdSelectPJMUser.Connection = VayuConnection;
                ...
                cmdSelectCAISOUser.Connection = VayuConnection;
                ...
                cmdSelectERCOTUser.Connection = VayuConnection;
            }
            catch (Exception ex)
            {
            }
        ...
        public static List<string> GetCity(string market)
        {
            LoadDB();
            ...
            if (market == "ERCOT")
            {
                ...
                cmd.CommandText = "select LABEL + SPACE(1) +StateName from WSIICAOCode  where region='Ercot' order by LABEL";
                cmd.Connection = VayuConnection;
                SqlDataReader rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                    string city = rdr.GetValue(0).ToString();
        ...
        public static List<Account> GetAccount(string user, string product, string market)
        {
            ...
            if (market != "ERCOT External")
            {
                ...
                SqlCommand cmdusertype = VayuConnection.CreateCommand();
                cmdusertype.CommandText = "select user_type from END_USER where ad_login=" + "'" + user + "' ";
                cmdusertype.Connection = VayuConnection;
                SqlDataReader cmdusertypedr = cmdusertype.ExecuteReader();
                while (cmdusertypedr.Read())
                {
                    usertype = cmdusertypedr.GetValue(0).ToString();
                ...
                rdr.Close();
                SqlCommand cmd1 = VayuConnection.CreateCommand();
                foreach (Account account in accountList)
                {
                    if (VayuConnection.State == ConnectionState.Closed)
                    {
            ...
            if (market == "ERCOT External")
            {
                ...
                foreach (Account account1 in accountList)
                {
                    ...
                    if (product == "EES/PTP")
                    {
                        cmd.CommandText = "select distinct  b.ParticipantID,b.Participant from Vayu..DAM60DAYPTPAWARDS a join Vayu..Company b ON a.ParticipantID=b.ParticipantID where b.Marketkey=9 and b.Participant not in ('QENJRE' ) order by b.Participant";// Sangram ,'QISO2'
                        cmd.Connection = VayuConnection;
                        SqlDataReader rdr1 = cmd.ExecuteReader();
                        while (rdr1.Read())
                        {
        ...
        public static List<Bid> GetCleareds(bool isUpto, int marketKey, int portfolioKey, DateTime startDate, DateTime endDate)
        {
            ...
            if (isUpto)
            {
                ...
                if (marketKey == 10)
                {
                    string sDate = startDate.AddMonths(0).ToString("yyyy-MM-dd");
                    string eDate = endDate.AddMonths(0).AddDays(1).ToString("yyyy-MM-dd");

                    cmdErcotExternalSelectUptoCleared.Parameters["@portfoliokey"].Value = portfolioKey;
                    cmdErcotExternalSelectUptoCleared.Parameters["@startdate"].Value = startDate;
                    cmdErcotExternalSelectUptoCleared.Parameters["@enddate"].Value = endDate.AddDays(1);
        ...
        public static List<Bid> GetUnCleareds(bool isUpto, int marketKey, int portfolioKey, DateTime startDate, DateTime endDate)
        {
            LoadDB();
            List<Bid> bidList = new List<Bid>();
            SqlDataReader reader = null;
            ...
            if (isUpto)
            {
                ...
                if (marketKey == 9)
                {
                    cmdErcotSelectUptoUnCleared.Parameters["@portfoliokey"].Value = portfolioKey;
                    cmdErcotSelectUptoUnCleared.Parameters["@startdate"].Value = startDate;
                    cmdErcotSelectUptoUnCleared.Parameters["@enddate"].Value = endDate.AddDays(1);
                    reader = cmdErcotSelectUptoUnCleared.ExecuteReader();
                }
                if (marketKey == 10)
                {
                    string sDate = startDate.AddMonths(0).ToString("yyyy-MM-dd");
        ...
        /// <returns></returns>
        public static List<CRRTransaction> GetFtrTransactions(string auction, int marketkey)
        {
            LoadDB();
            //
            ...
            if (marketkey == 9)
            {
                ...
                cmdSelectFtrTransaction.Connection = VayuConnection;
            }

            List<CRRTransaction> transactions = new List<CRRTransaction>();
            if (VayuConnection.State == ConnectionState.Closed)
            {
                VayuConnection.Open();
            }
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    CRRTransaction transaction = new CRRTransaction();
        ...
        public static List<FTRBid> GetFtrBidList(int portfoliokey, string auction, bool isValid, int marketKey, List<string> ids)
        {
            ...
            if (marketKey == 9)
            {
                ...
                cmdSelectFtrBid.Connection = VayuConnection;
            }
        ...
        public static List<FTRBid> GetAnnualFtrBidList(int portfoliokey, string auction, bool isValid, int marketKey, List<string> ids)
        {
            LoadDB();
            int count = isValid ? 2 : 1;
            List<FTRBid> ftrBidList = new List<FTRBid>();
            ...
            {
                cmdSelectFtrBid.CommandText = "select FB.source,FB.sink,FB. mw1,FB. price1,FB. mw2,FB. price2,FB. mw3,FB. price3,FB. mw4,FB. price4,FB. mw5,FB. price5,FB. mw6,FB. price6,FB.classtype,FB.tradetype, " +
                                            " FB.hedgetype,FB.CRRBidsKey,FB.Status,SourceZone.Zone as SourceZone," +
                                            " SinkZone.Zone as SinkZone,SourceZone.Nodekey as SourceNodekey, SinkZone.Nodekey as SinkNodeKey from CRRBidsAnnual  (nolock) as FB  Join Node As SourceZone on FB.Source=SourceZone.NodeName Join Node AS SinkZone on FB.Sink=SinkZone.NodeName " +
                                            " where FB.portfoliokey = @portfoliokey and FB.auction =@auction and SourceZone.MarketKey=9 and SinkZone.MarketKey=9";
                cmdSelectFtrBid.Connection = VayuConnection;
            }
            for (int i = 0; i < count; i++)
        ...
        public static List<FTRBid> GetFtrBids(int portfoliokey, string auction, int MarketKey)
        {
            ...
            List<FTRBid> ftrBidList = new List<FTRBid>();
            if (VayuConnection.State.Equals(System.Data.ConnectionState.Closed))
            {
                VayuConnection.Open();
            }
        ...
        public static Dictionary<int, string> GetFtrPortfolio(int MarketKey)
        {
            ...
            cmsSelectftrPortfilio.Parameters["@Hub"].Value = "Ercot";
        ...
        public static void GetSourceSinkNodeList(Action<Tuple<List<PricingNode>, List<PricingNode>>, Exception> callback, string market, string product)
        {
            ...
            if (product == "BOTH" || product == "VIRTUAL" || market == "PJM " || product == "CRR" || product == "Crr")
            {
                if (marketKey == 3)
                {
        ...
        public static List<int> GetCurrentBids(string market, IEnumerable<int> portfolioIDs, DateTime startDate, bool isUptos)
        {
            ...
            if (market == "PJM" && bidList.Count != 0)
            {
                ...
                ids = ids.Trim(',');
                SqlCommand sCmd = new SqlCommand("select NodeKey from node  where ExternalNodeID in(select distinct ExternalNodeID from node  where nodekey  in (" + ids + "))", VayuConnection);
        ...
        public static List<int> GetCurrenERCOTBids(string market, IEnumerable<int> portfolioIDs, DateTime startDate, bool isUptos)
        {
            if (string.IsNullOrEmpty(market) || portfolioIDs == null || portfolioIDs.Count() == 0)
                return null;
            ...
            {
                cmdSelectPortfolioSourceUptos.CommandText = "select distinct SourceNodeKey from ErcotPTPBids where EndMarketDateTime > @startDate and EndMarketDateTime <=@endDate and " +
                    "portfoliokey in ( " + portList + " )";
                cmdSelectPortfolioSourceUptos.Parameters["@portfoliokey"].Value = portList;
                cmdSelectPortfolioSourceUptos.Parameters["@startdate"].Value = startDate;
                cmdSelectPortfolioSourceUptos.Parameters["@enddate"].Value = startDate.AddDays(1);
                ...
                cmdSelectPortfolioSinkUptos.CommandText = "select distinct SinkNodeKey from ErcotPTPBids where EndMarketDateTime > @startDate and EndMarketDateTime <=@endDate and " +
                    "portfoliokey in ( " + portList + " )";
                cmdSelectPortfolioSinkUptos.Parameters["@portfoliokey"].Value = portList;
                cmdSelectPortfolioSinkUptos.Parameters["@startdate"].Value = startDate;
                cmdSelectPortfolioSinkUptos.Parameters["@enddate"].Value = startDate.AddDays(1);
        ...
        public static List<Bid> GetBids(string market, int portfolio, string savedName, DateTime start, DateTime end, bool isUptos, string inStatus)
        {
            ...
            if (isUptos)
            {
                ...
                {
                    cmdSelectErcotExternalBids.Parameters["@start"].Value = start;
                    cmdSelectErcotExternalBids.Parameters["@end"].Value = end;
                    cmdSelectErcotExternalBids.Parameters["@portfoliokey"].Value = portfolio;
                    reader = cmdSelectErcotExternalBids.ExecuteReader();
                }
            }
        ...
        /// <returns></returns>
        public static PricingNode GetNode(int externalId, int marketKey = 1)
        {
            int nodeKey = 0;
            if (marketKey == 1)
            {
        ...
        public static bool GetPJMValidVirtualNodes(long PNodeId)
        {
            ...
            cmdSelectPJMValidVirtualNodes = VayuConnection.CreateCommand();
        ...
        public static Dictionary<int, double> GetNodeTradedVolume(DateTime Date, bool source)
        {
            Dictionary<int, double> TradedVolume = new Dictionary<int, double>();
            if (VayuConnection.State == ConnectionState.Closed)
            {
                VayuConnection.Open();
            }
            SqlCommand cmdTradeVol = VayuConnection.CreateCommand();
            if (source)
            {
                cmdTradeVol.CommandText = "select NodeKey, sum(SourceVolume) from TradedVolume where MarketDateTime> '" + Date.AddDays(-1) + "' and MarketDateTime<= '" + Date + "'  " +
                "group by NodeKey";
            }
            else
            {
                cmdTradeVol.CommandText = "select NodeKey, sum(SinkVolume) from TradedVolume where MarketDateTime> '" + Date.AddDays(-1) + "' and MarketDateTime<= '" + Date + "'  " +
                "group by NodeKey";
            }

            cmdTradeVol.Connection = VayuConnection;

            SqlDataReader cmdTradeVolrdr = cmdTradeVol.ExecuteReader();
            while (cmdTradeVolrdr.Read())
            {
                int nodekey = cmdTradeVolrdr.GetInt32(0);
                double volume = cmdTradeVolrdr.IsDBNull(1) ? 0 : Convert.ToDouble(cmdTradeVolrdr.GetValue(1));
                if (volume == 0)
                { continue; }
                TradedVolume.Add(nodekey, volume);
            }
            return TradedVolume;
        }
        ...
        public static List<Portfolio> GetFTRPortfolio(DateTime bidDate, string user, string product, string market, string auctionname)
        {
            ...
            if (usertype == "user")
            {
                ...
                cmdSelectFTRPortfolio.CommandText = "select STRIP, Portfolio_ID from PORTFOLIO P inner join account A on P.account=A.account_id where HUB = '" + market + "' and A.flag_deprecated=0and product = 'CRR' and ACTIVE = 'Y' order by STRIP";
            ...
            while (reader.Read())
            {
                ...
                if (count <= 0)
                {
                    ...
                    if (user == "gojira")
                    {
                        ...
                        addportfolio.ID = 674;
                        addportfolio.Name = "Vayu_CRR_STRAT";
        ...
        public static List<Portfolio> GetExterFTRPortfolio(DateTime bidDate, string user, string product, string market, string auctionname)
        {
            ...
            try
            {
                ...
                SqlCommand selectexternalportfolio = VayuConnection.CreateCommand();
                selectexternalportfolio.CommandText = "Select * from pjm.FTRExternalPortfolios";
                selectexternalportfolio.Connection = VayuConnection;
        ...
        public static void SaveFtrErcotBidsAnnual(int portfolioKey, string auction, List<FTRBid> bids)
        {
            LoadDB();
            if (VayuConnection.State == ConnectionState.Closed)
            {
            ...
            cmdDeleteFtrBidAnnualErcot.Parameters["@auction"].Value = auction;
            cmdDeleteFtrBidAnnualErcot.Parameters["@portfoliokey"].Value = portfolioKey;
            cmdDeleteFtrBidAnnualErcot.ExecuteNonQuery();
            foreach (FTRBid bid in bids)
            {
                //cmdInsertFtrBidAnnualCommandErcot.Parameters["@PeriodKey"].Value = bid.PeriodKey;
                cmdInsertFtrBidAnnualCommandErcot.Parameters["@Participant"].Value = bid.mParticipant;
                cmdInsertFtrBidAnnualCommandErcot.Parameters["@MarketKey"].Value = bid.mMarketKey;
                cmdInsertFtrBidAnnualCommandErcot.Parameters["@hedgetype"].Value = bid.HedgeType;

                cmdInsertFtrBidAnnualCommandErcot.Parameters["@month"].Value = bid.month;
                cmdInsertFtrBidAnnualCommandErcot.Parameters["@auction"].Value = auction;
                cmdInsertFtrBidAnnualCommandErcot.Parameters["@startdate"].Value = bid.StartDate;
                cmdInsertFtrBidAnnualCommandErcot.Parameters["@enddate"].Value = bid.EndDate;
                cmdInsertFtrBidAnnualCommandErcot.Parameters["@classtype"].Value = bid.ClassType;
                cmdInsertFtrBidAnnualCommandErcot.Parameters["@tradetype"].Value = bid.TradeType;
                cmdInsertFtrBidAnnualCommandErcot.Parameters["@hedgetype"].Value = bid.HedgeType;

                cmdInsertFtrBidAnnualCommandErcot.Parameters["@portfoliokey"].Value = portfolioKey;
                //cmdInsertFtrBidAnnualCommandErcot.Parameters["@periodhours"].Value = bid.PeriodHours;
                //cmdInsertFtrBidAnnualCommandErcot.Parameters["@periodname"].Value = bid.PeriodName;
                //cmdInsertFtrBidAnnualCommandErcot.Parameters["@periodtype"].Value = bid.PeriodName;
                cmdInsertFtrBidAnnualCommandErcot.Parameters["@source"].Value = bid.Source;
                //cmdInsertFtrBidAnnualCommandErcot.Parameters["@sourceextid"].Value = bid.SourceExt;
                cmdInsertFtrBidAnnualCommandErcot.Parameters["@sink"].Value = bid.Sink;
                //cmdInsertFtrBidAnnualCommandErcot.Parameters["@sinkextid"].Value = bid.SinkExt;

                //if (bid.TCRID == 0) 
                //  cmdInsertFtrBidAnnualCommandErcot.Parameters["@TcrId"].Value = DBNull.Value;
                //else
                //  cmdInsertFtrBidAnnualCommandErcot.Parameters["@TcrId"].Value = bid.TCRID;

                cmdInsertFtrBidAnnualCommandErcot.Parameters["@mw1"].Value = bid.MW1;
                cmdInsertFtrBidAnnualCommandErcot.Parameters["@price1"].Value = bid.Price1;
                if (bid.MW2 == null)
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@mw2"].Value = DBNull.Value;
                }
                else
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@mw2"].Value = bid.MW2;
                }
                if (bid.Price2 == null)
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@price2"].Value = DBNull.Value;
                }
                else
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@price2"].Value = bid.Price2;
                }
                if (bid.MW3 == null)
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@mw3"].Value = DBNull.Value;
                }
                else
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@mw3"].Value = bid.MW3;
                }
                if (bid.Price3 == null)
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@price3"].Value = DBNull.Value;
                }
                else
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@price3"].Value = bid.Price3;
                }
                if (bid.MW4 == null)
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@mw4"].Value = DBNull.Value;
                }
                else
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@mw4"].Value = bid.MW4;
                }
                if (bid.Price4 == null)
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@price4"].Value = DBNull.Value;
                }
                else
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@price4"].Value = bid.Price4;
                }
                if (bid.MW5 == null)
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@mw5"].Value = DBNull.Value;
                }
                else
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@mw5"].Value = bid.MW5;
                }
                if (bid.Price5 == null)
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@price5"].Value = DBNull.Value;
                }
                else
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@price5"].Value = bid.Price5;
                }
                if (bid.MW6 == null)
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@mw6"].Value = DBNull.Value;
                }
                else
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@mw6"].Value = bid.MW6;
                }
                if (bid.Price6 == null)
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@price6"].Value = DBNull.Value;
                }
                else
                {
                    cmdInsertFtrBidAnnualCommandErcot.Parameters["@price6"].Value = bid.Price6;
                }

                try
                {
                    cmdInsertFtrBidAnnualCommandErcot.ExecuteNonQuery();
                }
                catch (Exception ex) { }
            }
            VayuConnection.Close();
