...
namespace Vayu.CommonControls
{
    ...
    public class ExportToExcelNodeSpread<T, U>
        where T : class
        where U : List<T>
    {
        #region Declaration
        ...
        private object[] CreateHeader()
        {
            ...
            {
                if (headerInfo[n].Name.Equals("Date") || headerInfo[n].Name.Equals("RowType") || headerInfo[n].Name.Equals("RowNumber") || headerInfo[n].Name.Equals("SourceVolume") || headerInfo[n].Name.Equals("SinkVolume"))
                    continue;
