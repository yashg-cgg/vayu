...
namespace Vayu.CommonControls
{
        ...
        where U : List<T>
    {
        ...
        /// </summary>
        /// <param name="HideProperty">The hide property.</param>
        public void GenerateReport(List<string> HideProperty)
        {
            try
            {
                if (dataToPrint != null)
        ...
        /// </summary>
        /// <param name="HideProperty">The hide property.</param>
        private void FillSheet(List<string> HideProperty)
        {
            object[] header = CreateHeader(HideProperty);
            WriteData(header);
        }
        /// <summary>
        ...
        /// <param name="HideProperty">The hide property.</param>
        /// <returns></returns>
        private object[] CreateHeader(List<string> HideProperty)
        {
            PropertyInfo[] headerInfo = typeof(T).GetProperties();
            ...
            for (int n = 0; n < headerInfo.Length; n++)
            {
                if (HideProperty.Contains(headerInfo[n].Name))
                    continue;
                objHeaders.Add(headerInfo[n].Name);
            }
