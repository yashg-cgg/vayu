...
namespace Vayu.WCFPubSubBase
{
    ...
    public abstract class WCFSubscriberBase<SUBSCRIBERCLASS, ISERVICECONTRACT>
        where ISERVICECONTRACT : IPublisher  // SUBSCRIBERCLASS is subscriber class, ISERVICECONTRACT is ServiceContract interface which must be of type IPublisher
    {
        /// <summary>
        /// The reconnect timer
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WCFSubscriberBase{SUBSCRIBERCLASS, ISERVICECONTRACT}"/> class.
        /// </summary>
        public WCFSubscriberBase()
        {
        ...
        public WCFSubscriberBase(TextWriter myLogfile)
            : this()
        {
            mLogFile = myLogfile;
        ...
        {
            int i = 4;
            ((IPublisher)proxySettingHash[myProxyIndex].proxy).Subscribe(isAlgo);
        }
        /// <summary>
