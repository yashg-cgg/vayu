    ...
    public class LMPDatesHelper
    {
        ...
        public List<MarketTime> GetMarketTimings(int marketKey, DateTime startDateTime, DateTime endDateTime, bool isIce = true)
        {
            ...
            try
            {
                ...
                if (marketKey == 2 && isIce)
                {
                    //SetCommonParameterValues(mSelectICEMarketDateTimeCommand, startDateTime, endDateTime, marketKey);
                    //reader = mSelectICEMarketDateTimeCommand.ExecuteReader();
                }
                else if (marketKey == 12)
                {
                    //SetCommonParameterValues(mSelectSPPMarketDateTimeCommand, startDateTime, endDateTime, marketKey);
                    //reader = mSelectSPPMarketDateTimeCommand.ExecuteReader();
                }
                else
                {
