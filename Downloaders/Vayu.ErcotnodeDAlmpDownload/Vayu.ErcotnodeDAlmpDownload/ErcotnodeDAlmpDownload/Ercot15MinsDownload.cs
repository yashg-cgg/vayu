...
namespace Vayu.ErcotnodeDAlmpDownload
{
    class Ercot15MinsDownload
    {
        ...
        //    selectUserPasswordCommand.CommandText = " select CertificateName,Password from Certificate where  Application_Name='ProdClientAPI'";
        //    selectUserPasswordCommand.Parameters.AddWithValue("@Password", "Password");
        //    selectUserPasswordCommand.Connection = VayuDbConn;
        //   // string certFileName = @"D:\ISOFiles\ErcotnodeDAlmpDownload\ErcotTrader\Renewed\2019_20\";
        //    string certFileName = @"H:\Certificate\Prod\API\";
        //    string certPasswd = "";
        //    VayuDbConn.Open();
        ...
        public void DownloadLoadResources()
        {
            try
            {
                ...
                for (int k = 6; k < splinelitRow.Length; k = k + 6)
                {
                    ...
                    using (SqlBulkCopy bk15Min = new SqlBulkCopy(VayuDbConnErcot, SqlBulkCopyOptions.TableLock, transaction))
                    {
                        try
                        {
                            ...
                            SqlCommand updateNodeDALMPH = new SqlCommand("[UpMergeNodeLMP2]", VayuDbConnErcot, transaction);
