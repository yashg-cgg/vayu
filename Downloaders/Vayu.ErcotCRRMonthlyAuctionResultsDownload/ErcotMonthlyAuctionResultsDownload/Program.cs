...
namespace Vayu.ErcotCRRMonthlyAuctionResultsDownload
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            mErcotMonthlyAuctionResultsDownload.DownloadUpdate(new DateTime(2026, 04, 01));//First run (main) yyyy/mm/dd

            //ErcotMonthlyAuctionResultsDownload1 mErcotMonthlyAuctionResultsDownload1 = new ErcotMonthlyAuctionResultsDownload1();
            //mErcotMonthlyAuctionResultsDownload1.DownloadUpdate(new DateTime(2026, 04, 01));// secondly should run
