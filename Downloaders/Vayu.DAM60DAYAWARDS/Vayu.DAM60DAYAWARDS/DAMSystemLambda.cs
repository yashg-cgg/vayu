        ...
        private void Download()
        {
            ...
            try
            {
                ...
                for (int k = 6; k < splinelitRow.Length; k = k + 6)
                {
                    ...
                    CSVUnZipFile(fileDestName, folderFilename);
                    ...
                    //mERCOTDAMSystemLambdaDT.Columns.Add("NodeKey", typeof(int));
                    mERCOTDAMSystemLambdaDT.Columns.Add("DeliveryDate", typeof(DateTime));
                    //mERCOTDAMSystemLambdaDT.Columns.Add("HourEnding", typeof(string));
