...
{
    public class ErcotMonthlyAuctionResultsDownload
    {
        ...
        public ErcotMonthlyAuctionResultsDownload()
        {
        ...
        private void Download(DateTime processDate, int CRRAuctionkey, bool updateAuctionResults = true, bool updateNodalPrices = true, bool updateOptionPrices = true)
        {
            ...
            for (int i = 3; i < 4; i = 4)
            {
                // FileURL = "https://mis.ercot.com/misdownload/servlets/mirDownload?mimic_duns=0809369482000&doclookupId=748950289";
               // FileURL = "http://mis.ercot.com/misdownload/servlets/mirDownload?mimic_duns=000000000&doclookupId=769832789";
            ...
            // string FileName = @"D:\ISOFiles\ERCOTAuction\rpt.00011201.0000000000000000.20200123.100052517.FEB2020MonthlyCRRAuctionResults.zip";
            ...
            //{
            //    UpdateOptionPrices(optionFile, CRRAuctionkey, processDate, "OBL");
            //    UpdateOptionPrices(optionFile, CRRAuctionkey, processDate, "OPT");
            //}
        ...
        public void InitDB()
        {
            ...
            mOptionPriceDT.Columns.Add("MWWD", typeof(double));
            mOptionPriceDT.Columns.Add("MWOffP", typeof(double));
            mOptionPriceDT.Columns.Add("MWWE", typeof(double));
        ...
        public void UpdateOptionPrices(string fileName, int CRRAuctionkey, DateTime date, string HedgeType)
        {
            FillPeriodHash(date);
            string month = date.ToString("MMM").ToUpper();
            ...
            //Parallel.ForEach(nodeName, new ParallelOptions { MaxDegreeOfParallelism = 5}, item =>
            {
                ...
                if (item.Source == "STP_STP_G1" && item.Sink == "DOWGEN_PUN2")
                {
        ...
        protected virtual void FillPeriodHash(DateTime date)
        {
            ...
            else
            {
               //// start = new DateTime(date.Year + 1 - 1, 6, 1);
                ...
                end = new DateTime(date.Year , 5, 31);
            }
        ...
        public void InsertIntoDB(DataTable monthlyDT)
        {
            ...
            using (SqlBulkCopy bkMAuction = new SqlBulkCopy(DBConnection, SqlBulkCopyOptions.TableLock, transaction))
            {
                try
                {
                    bkMAuction.DestinationTableName = "CRRAuctionResults_test";
        ...
        public void NodalPriceInsert(DataTable mNodalData)
        {
            ...
            using (SqlBulkCopy BKNodalPrice = new SqlBulkCopy(DBConnection, SqlBulkCopyOptions.TableLock, transaction))
            {
                try
                {
                    BKNodalPrice.DestinationTableName = "CRR6MAuctionNodePrice_TEST";
        ...
        public void InsertOptionPrice(DataTable mOptionData)
        {
            ...
            using (SqlBulkCopy BKOptionPrice = new SqlBulkCopy(DBConnection, SqlBulkCopyOptions.TableLock, transaction))
            {
                try
                {
                    BKOptionPrice.DestinationTableName = "CRR6MAuctionOptionPricesde"; 
                    ...
                    BKOptionPrice.ColumnMappings.Add("PeakWDMW", "PeakWDMW");
                    BKOptionPrice.ColumnMappings.Add("BidPricePeakWD", "BidPricePeakWD");
                    BKOptionPrice.ColumnMappings.Add("OffPeak", "OffPeak");
                    BKOptionPrice.ColumnMappings.Add("OffPeakMW", "OffPeakMW");
                    BKOptionPrice.ColumnMappings.Add("BidPriceOffpeak", "BidPriceOffpeak");
                    BKOptionPrice.ColumnMappings.Add("PeakWE", "PeakWE");
                    BKOptionPrice.ColumnMappings.Add("PeakWEMW", "PeakWEMW");
                    BKOptionPrice.ColumnMappings.Add("BidPricePeakWE", "BidPricePeakWE");
                    BKOptionPrice.ColumnMappings.Add("BidType", "BidType");
                    BKOptionPrice.ColumnMappings.Add("HedgeType", "HedgeType");
                    BKOptionPrice.ColumnMappings.Add("PeriodKey", "PeriodKey");
                    BKOptionPrice.ColumnMappings.Add("MWWD", "MWWD");
                    BKOptionPrice.ColumnMappings.Add("MWOffP", "MWOffP");
                    BKOptionPrice.ColumnMappings.Add("MWWE", "MWWE");
