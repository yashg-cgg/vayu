...
namespace Vayu.PNLDownload
{
    ...
    public class FeeDownload
    {
       ...
       //    private DateTime mPjmStartDate = DateTime.Parse("2018-07-1 00:00:00.000");
        private DateTime mPjmEndDate = DateTime.Today;
       // private DateTime mPjmEndDate = DateTime.Parse("2017-12-31 00:00:00.000");
        #endregion
        ...
        private double GetNetPnlFromMonthToDateStmt(DateTime startDate, string user, string password)
        {
            ...
            DateTime lastDate = startDate.AddMonths(1).AddDays(-1);
            //uptosHash = new Dictionary<DateTime, double>();
            string SourcePath = "https://msrs.pjm.com/msrs/browserless.do?report=month-to-datebill-csvandxml&version=L&format=X&start=" + startDate + "&stop=" + lastDate;//+ "&username=" + user + "&password=" + password;
            #region New Code
            ...
            httpreq.Headers.Add("Authorization", basicAuth);
