   ...
   public class CRRServer : ISourceSink
    {
        ...
        private string tradingDBString = Vayu.CommonAccessLibrary.DBConnectionCredentials.GetERCOTDBConnection().ToString();
        private string tradingDBStringERCOT = Vayu.CommonAccessLibrary.DBConnectionCredentials.GetERCOTDBConnection().ToString();
