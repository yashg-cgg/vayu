...
namespace Vayu.CRRPNLService
{
    ...
    public class CRRServer : ISourceSink
    {
        ...
        private void InitDB()
        {
            VayuConnection = VayuDBConnection.GetInstance().GetSqlConnection();
            ...
            mSelectCalendarCommand.Connection = VayuConnection;
            //
            ...
            mSelectPeriodCommand.Connection = VayuConnection;
            //
            ...
            mSelectPeriodDateCommand.Connection = VayuConnection;  
            ...
            mSelectAllErcotSourceAndSinkFtrCommand.Connection = VayuConnection;
            ...
            mSelectAllCaisoSourceAndSinkFtrCommand.Connection = VayuConnection;
            //
            ...
            mSelectAllMisoSourceAndSinkFtrCommand.Connection = VayuConnection;
            //
            ...
            mSelectAllSPPSourceAndSinkFtrCommand.Connection = VayuConnection;
            //
            ...
            mSelectAllPJMSourceAndSinkFtrCommand.Connection = VayuConnection;
            //
            ...
            mSelectPriceCommandErcot.Connection = VayuConnection;
            ...
            mSelectPriceCommandErcotOption.Connection = VayuConnection;
            ...
            mSelectPriceCommandErcotOptionMonthly.Connection = VayuConnection;
            ...
            mSelectPriceCommandPJMOptionMonthly.Connection = VayuConnection;
        ...
        /// <param name="HedgeType"></param>
        /// <param name="ftrQuarterMonth"></param>
            ...
            if (HedgeType == "OBL")
            {
                if (ftrQuarterMonth != 0)
                {
                    ...
                    foreach (int year in yearList)
                    {
                        ...
                        mSelectQuarterlyPriceCommand.Connection = VayuConnection;
                ...
                SqlConnection cmd = VayuDBConnection.GetInstance().GetSqlConnection();
        ...
        public Dictionary<DateTime, string> GetPeakYN_daterange(DateTime startDate, DateTime endDate)
        {
            ...
            mSelectPeakYN_daterang.Connection = VayuConnection;
            ...
            if (Hedgetype == "OBL")
            {
                if (ftrQuarterMonth != 0)
                {
                    ...
                    foreach (int year in yearList)
                    {
                        ...
                        mSelectQuarterlyPriceCommandErcot.Connection = VayuConnection;
                ...
                if (ftrQuarterMonth != 0)
                {
                    ...
                    foreach (int year in yearList)
                    {
                        mSelectQuarterlyPriceCommandErcotOption.CommandText = " select c.startdate ,  si.LMPOnPeak - b.LMPOnPeak , si.LMPOffPeak - b.LMPOffPeak  , c.PeakHrs , c.OffPeakHrs , c.PeriodKey, si.PeakWE - b.PeakWE, c.PEAKWE from crrauction a,CRRAuctionNodePrice b " +
                            ...
                            " a.CRRAuctionKey = (select max(a.CRRAuctionkey) from crrauction a, CRRAuctionNodePrice b where  b.periodkey = " +
                            " (select periodkey from period where startdate =  '" + ftrQuarterMonth.ToString() + "/1/" + year.ToString() + "' and periodtype = 'seasonal' and marketkey = 9) and a.CRRAuctionKey = b.CRRAuctionKey) ";
                        mSelectQuarterlyPriceCommandErcotOption.Connection = VayuConnection;
