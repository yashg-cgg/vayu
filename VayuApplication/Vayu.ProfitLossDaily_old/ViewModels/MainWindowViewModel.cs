...
namespace Vayu.ProfitLossDaily.ViewModels
{
    ...
    public class MainWindowViewModel : BindableBase
    {
        ...
        private bool mSortRTChecked = true;
        ...
        private double? _TotalDAMWCollect;

        public double? TotalDAMWCollect
        {
            get { return _TotalDAMWCollect; }
            set
            {
                _TotalDAMWCollect = value;
                RaisePropertyChanged("TotalDAMWCollect");
            }
        }
        ...
        public double? TotalRevenu
        {
            ...
            set
            {
                ...
                mTotalRevenu = value;
                RaisePropertyChanged("TotalRevenu");
            }
        ...
        private void CalculateExposure() // Calculates exposure of portfolio and shown in exposure tab
        {
            try
            {
                ...
                if (SelectedMarket.ToUpper() == "ERCOT")
                    ConstraintsList = _dataService.GetPNLConstraints(PNLList, SortDollarChecked, StartDate, EndDate.AddDays(1), 9, SortRTChecked);

                if (SelectedMarket.ToUpper() == "ERCOT PTP")
                    ConstraintsList = _dataService.GetPNLConstraintsEOM(PNLList, SortDollarChecked, StartDate, EndDate.AddDays(1), 9);
                ...
                foreach (PNLConstraints itemPNLConstraints in ConstraintsList)
                {
                    ...
                    if (SelectedMarket.ToUpper() == "ERCOT PTP")
                    {
                        ...
                        {
                            mPNLConstraints.he1Value = itemPNLConstraints.he1Value;
                            mPNLConstraints.he2Value = itemPNLConstraints.he2Value;
                            mPNLConstraints.he3Value = itemPNLConstraints.he3Value;
                            mPNLConstraints.he4Value = itemPNLConstraints.he4Value;
                            mPNLConstraints.he5Value = itemPNLConstraints.he5Value;
                            mPNLConstraints.he6Value = itemPNLConstraints.he6Value;
                            mPNLConstraints.he7Value = itemPNLConstraints.he7Value;
                            mPNLConstraints.he8Value = itemPNLConstraints.he8Value;
                            mPNLConstraints.he9Value = itemPNLConstraints.he9Value;
                            mPNLConstraints.he10Value = itemPNLConstraints.he10Value;
                            mPNLConstraints.he11Value = itemPNLConstraints.he11Value;
                            mPNLConstraints.he12Value = itemPNLConstraints.he12Value;
                            mPNLConstraints.he13Value = itemPNLConstraints.he13Value;
                            mPNLConstraints.he14Value = itemPNLConstraints.he14Value;
                            mPNLConstraints.he15Value = itemPNLConstraints.he15Value;
                            mPNLConstraints.he16Value = itemPNLConstraints.he16Value;
                            mPNLConstraints.he17Value = itemPNLConstraints.he17Value;
                            mPNLConstraints.he18Value = itemPNLConstraints.he18Value;
                            mPNLConstraints.he19Value = itemPNLConstraints.he19Value;
                            mPNLConstraints.he20Value = itemPNLConstraints.he20Value;
                            mPNLConstraints.he21Value = itemPNLConstraints.he21Value;
                            mPNLConstraints.he22Value = itemPNLConstraints.he22Value;
                            mPNLConstraints.he23Value = itemPNLConstraints.he23Value;
                            mPNLConstraints.he24Value = itemPNLConstraints.he24Value;
                    ...
                    else
                    {
                        if (SortDollarChecked)
                        {
                            //  foreach (var ConstraintItem in ConstraintsListfinal)
                            {


                                if ((itemPNLConstraints.he1Value == null))
                                    mPNLConstraints.he1Value = null;
                                else
                                    mPNLConstraints.he1Value = Math.Round((double)itemPNLConstraints.he1Value, 0);



                                if ((itemPNLConstraints.he2Value == null))
                                    mPNLConstraints.he2Value = null;
                                else
                                    mPNLConstraints.he2Value = Math.Round((double)itemPNLConstraints.he2Value, 0);


                                if ((itemPNLConstraints.he3Value == null))
                                    mPNLConstraints.he3Value = null;
                                else
                                    mPNLConstraints.he3Value = Math.Round((double)itemPNLConstraints.he3Value, 0);



                                if ((itemPNLConstraints.he4Value == null))
                                    mPNLConstraints.he4Value = null;
                                else
                                    mPNLConstraints.he4Value = Math.Round((double)itemPNLConstraints.he4Value, 0);



                                if ((itemPNLConstraints.he5Value == null))
                                    mPNLConstraints.he5Value = null;
                                else
                                    mPNLConstraints.he5Value = Math.Round((double)itemPNLConstraints.he5Value, 0);



                                if ((itemPNLConstraints.he6Value == null))
                                    mPNLConstraints.he6Value = null;
                                else
                                    mPNLConstraints.he6Value = Math.Round((double)itemPNLConstraints.he6Value, 0);


                                if ((itemPNLConstraints.he7Value == null))
                                    mPNLConstraints.he7Value = null;
                                else
                                    mPNLConstraints.he7Value = Math.Round((double)itemPNLConstraints.he7Value, 0);



                                if ((itemPNLConstraints.he8Value == null))
                                    mPNLConstraints.he8Value = null;
                                else
                                    mPNLConstraints.he8Value = Math.Round((double)itemPNLConstraints.he8Value, 0);


                                if ((itemPNLConstraints.he9Value == null))
                                    mPNLConstraints.he9Value = null;
                                else
                                    mPNLConstraints.he9Value = Math.Round((double)itemPNLConstraints.he9Value, 0);



                                if ((itemPNLConstraints.he10Value == null))
                                    mPNLConstraints.he10Value = null;
                                else
                                    mPNLConstraints.he10Value = Math.Round((double)itemPNLConstraints.he10Value, 0);



                                if ((itemPNLConstraints.he11Value == null))
                                    mPNLConstraints.he11Value = null;
                                else
                                    mPNLConstraints.he11Value = Math.Round((double)itemPNLConstraints.he11Value, 0);


                                if ((itemPNLConstraints.he12Value == null))
                                    mPNLConstraints.he12Value = null;
                                else
                                    mPNLConstraints.he12Value = Math.Round((double)itemPNLConstraints.he12Value, 0);





                                if ((itemPNLConstraints.he13Value == null))
                                    mPNLConstraints.he13Value = null;
                                else
                                    mPNLConstraints.he13Value = Math.Round((double)itemPNLConstraints.he13Value, 0);


                                if ((itemPNLConstraints.he14Value == null))
                                    mPNLConstraints.he14Value = null;
                                else
                                    mPNLConstraints.he14Value = Math.Round((double)itemPNLConstraints.he14Value, 0);


                                if ((itemPNLConstraints.he15Value == null))
                                    mPNLConstraints.he15Value = null;
                                else
                                    mPNLConstraints.he15Value = Math.Round((double)itemPNLConstraints.he15Value, 0);



                                if ((itemPNLConstraints.he16Value == null))
                                    mPNLConstraints.he16Value = null;
                                else
                                    mPNLConstraints.he16Value = Math.Round((double)itemPNLConstraints.he16Value, 0);


                                if ((itemPNLConstraints.he17Value == null))
                                    mPNLConstraints.he17Value = null;
                                else
                                    mPNLConstraints.he17Value = Math.Round((double)itemPNLConstraints.he17Value, 0);


                                if ((itemPNLConstraints.he18Value == null))
                                    mPNLConstraints.he18Value = null;
                                else
                                    mPNLConstraints.he18Value = Math.Round((double)itemPNLConstraints.he18Value, 0);


                                if ((itemPNLConstraints.he19Value == null))
                                    itemPNLConstraints.he19Value = null;
                                else
                                    mPNLConstraints.he19Value = Math.Round((double)itemPNLConstraints.he19Value, 0);

                                if ((itemPNLConstraints.he20Value == null))
                                    mPNLConstraints.he20Value = null;
                                else
                                    mPNLConstraints.he20Value = Math.Round((double)itemPNLConstraints.he20Value, 0);


                                if ((itemPNLConstraints.he21Value == null))
                                    mPNLConstraints.he21Value = null;
                                else
                                    mPNLConstraints.he21Value = Math.Round((double)itemPNLConstraints.he21Value, 0);

                                if ((itemPNLConstraints.he22Value == null))
                                    mPNLConstraints.he22Value = null;
                                else
                                    mPNLConstraints.he22Value = Math.Round((double)itemPNLConstraints.he22Value, 0);



                                if ((itemPNLConstraints.he23Value == null))
                                    mPNLConstraints.he23Value = null;
                                else
                                    mPNLConstraints.he23Value = Math.Round((double)itemPNLConstraints.he23Value, 0);

                                if ((itemPNLConstraints.he24Value == null))
                                    mPNLConstraints.he24Value = null;
                                else
                                    mPNLConstraints.he24Value = Math.Round((double)itemPNLConstraints.he24Value, 0);
                        ...
                        else
                        {
                            ...
                            //  foreach (var ConstraintItem in ConstraintsListfinal)
                            {
                                ...
                                if ((itemPNLConstraints.he1Value == null))
                                    ...
                                    mPNLConstraints.he1Value = Math.Round((double)itemPNLConstraints.he1Value, 1);
                                ...
                                if ((itemPNLConstraints.he2Value == null))
                                    ...
                                    mPNLConstraints.he2Value = Math.Round((double)itemPNLConstraints.he2Value, 1);


                                if ((itemPNLConstraints.he3Value == null))
                                    mPNLConstraints.he3Value = null;
                                else
                                    mPNLConstraints.he3Value = Math.Round((double)itemPNLConstraints.he3Value, 1);
                                ...
                                if ((itemPNLConstraints.he4Value == null))
                                    ...
                                    mPNLConstraints.he4Value = Math.Round((double)itemPNLConstraints.he4Value, 1);
                                ...
                                if ((itemPNLConstraints.he5Value == null))
                                    ...
                                    mPNLConstraints.he5Value = Math.Round((double)itemPNLConstraints.he5Value, 1);
                                ...
                                if ((itemPNLConstraints.he6Value == null))
                                    ...
                                    mPNLConstraints.he6Value = Math.Round((double)itemPNLConstraints.he6Value, 1);


                                if ((itemPNLConstraints.he7Value == null))
                                    mPNLConstraints.he7Value = null;
                                else
                                    mPNLConstraints.he7Value = Math.Round((double)itemPNLConstraints.he7Value, 1);
                                ...
                                if ((itemPNLConstraints.he8Value == null))
                                    ...
                                    mPNLConstraints.he8Value = Math.Round((double)itemPNLConstraints.he8Value, 1);


                                if ((itemPNLConstraints.he9Value == null))
                                    mPNLConstraints.he9Value = null;
                                else
                                    mPNLConstraints.he9Value = Math.Round((double)itemPNLConstraints.he9Value, 1);
                                ...
                                if ((itemPNLConstraints.he10Value == null))
                                    ...
                                    mPNLConstraints.he10Value = Math.Round((double)itemPNLConstraints.he10Value, 1);
                                ...
                                if ((itemPNLConstraints.he11Value == null))
                                    ...
                                    mPNLConstraints.he11Value = Math.Round((double)itemPNLConstraints.he11Value, 1);


                                if ((itemPNLConstraints.he12Value == null))
                                    mPNLConstraints.he12Value = null;
                                else
                                    mPNLConstraints.he12Value = Math.Round((double)itemPNLConstraints.he12Value, 1);
                                ...
                                if ((itemPNLConstraints.he13Value == null))
                                    ...
                                    mPNLConstraints.he13Value = Math.Round((double)itemPNLConstraints.he13Value, 1);


                                if ((itemPNLConstraints.he14Value == null))
                                    mPNLConstraints.he14Value = null;
                                else
                                    mPNLConstraints.he14Value = Math.Round((double)itemPNLConstraints.he14Value, 1);


                                if ((itemPNLConstraints.he15Value == null))
                                    mPNLConstraints.he15Value = null;
                                else
                                    mPNLConstraints.he15Value = Math.Round((double)itemPNLConstraints.he15Value, 1);
                                ...
                                if ((itemPNLConstraints.he16Value == null))
                                    ...
                                    mPNLConstraints.he16Value = Math.Round((double)itemPNLConstraints.he16Value, 1);


                                if ((itemPNLConstraints.he17Value == null))
                                    mPNLConstraints.he17Value = null;
                                else
                                    mPNLConstraints.he17Value = Math.Round((double)itemPNLConstraints.he17Value, 1);


                                if ((itemPNLConstraints.he18Value == null))
                                    mPNLConstraints.he18Value = null;
                                else
                                    mPNLConstraints.he18Value = Math.Round((double)itemPNLConstraints.he18Value, 1);


                                if ((itemPNLConstraints.he19Value == null))
                                    itemPNLConstraints.he19Value = null;
                                else
                                    mPNLConstraints.he19Value = Math.Round((double)itemPNLConstraints.he19Value, 1);

                                if ((itemPNLConstraints.he20Value == null))
                                    mPNLConstraints.he20Value = null;
                                else
                                    mPNLConstraints.he20Value = Math.Round((double)itemPNLConstraints.he20Value, 1);


                                if ((itemPNLConstraints.he21Value == null))
                                    mPNLConstraints.he21Value = null;
                                else
                                    mPNLConstraints.he21Value = Math.Round((double)itemPNLConstraints.he21Value, 1);

                                if ((itemPNLConstraints.he22Value == null))
                                    mPNLConstraints.he22Value = null;
                                else
                                    mPNLConstraints.he22Value = Math.Round((double)itemPNLConstraints.he22Value, 1);
                                ...
                                if ((itemPNLConstraints.he23Value == null))
                                    ...
                                    mPNLConstraints.he23Value = Math.Round((double)itemPNLConstraints.he23Value, 1);

                                if ((itemPNLConstraints.he24Value == null))
                                    mPNLConstraints.he24Value = null;
                                else
                                    mPNLConstraints.he24Value = Math.Round((double)itemPNLConstraints.he24Value, 1);
        ...
        private void CalculateEMOPNLOLD() // calculates daily pnl and fees for both summery and details
        {
            try
            {
                double count = 0.0;
                ...
                PNLList = _dataService.getEMOPnl(StartDate, EndDate);


                double? TotalPNLCalculated = PNLList.Sum(a => a.PnlValue);
                double? TotalMWCalculated = PNLList.Sum(a => a.MW);
                double? TotalDollarClearedCalculated = PNLList.Sum(a => a.PayCollect);
                double? TotalRevenuCalculated = PNLList.Sum(a => a.Revenu);
                double? winpercentageCalculated = PNLList.Where(a => a.DART > 0).Count();
                double? finalwinpercentCalculated = winpercentageCalculated / pnlList.Count;
                double? percentMWCalculated = TotalPNLCalculated / TotalMWCalculated;
                ...
                TotalCollect = TotalDollarClearedCalculated;
                TotalMW = TotalMWCalculated / 2;
                TotalDAMWCollect = TotalPNL / TotalMW;
                WinText = winpercentageCalculated / PNLList.Count();
                //TotalPNL;
                PercentMW = TotalDollarClearedCalculated / TotalMW;
                TotalRevenu = TotalRevenuCalculated;
           ...
           /* try
            {
                ...
                TotalDAMWCollect = TotalCollect / TotalMW;
        ...
        private void CalculateEMOPNL() // calculates daily pnl and fees for both summery and details
        {
            try
            {
                List<Pnl> tempList1 = new List<Pnl>();
                ...
                DateTime dt = StartDate;
                PNLList = _dataService.getEMOPnl(StartDate, EndDate);
                PNLList = PNLList.OrderBy(obj => obj.HE).ToList();


                double? TotalPNLCalculated = PNLList.Select(a => a.PnlValue).Where(value => value.HasValue && !double.IsNaN(value.Value)).Sum(value => value.Value);

                double? TotalMWCalculated = PNLList.Sum(a => a.MW);
                double? TotalDollarClearedCalculated = PNLList.Sum(a => a.PayCollect);

                double? TotalRevenuCalculated = PNLList.Select(a => a.Revenu).Where(value => value.HasValue && !double.IsNaN(value.Value)).Sum(value => value.Value);
                ...
                {
                    finalPnlList = PNLList.ToList();
                    tempList1 = PNLList.Where(a => double.IsNaN(a.RT.Value)).ToList();
                    IncompleteHrsPnlList = PNLList.Where(a => !double.IsNaN(a.RT.Value)).ToList();
                }
                ...
                if (!IncomplteHrsChecked)
                {
                    TotalPNL = IncompleteHrsPnlList.Select(a => a.PnlValue).Where(value => value.HasValue && !double.IsNaN(value.Value)).Sum(value => value.Value);

                    TotalNetPNL = TotalPNL;
                    TotalMW = IncompleteHrsPnlList.Sum(a => a.MW);
                    TotalCollect = IncompleteHrsPnlList.Sum(a => a.PayCollect);
                    TotalFee = 0;
                    TotalNetPNL = TotalPNL;
                    TotalDollarClearedCalculated = IncompleteHrsPnlList.Sum(a => a.PayCollect);
                    TotalCollect = TotalDollarClearedCalculated;
                    TotalMWCalculated = IncompleteHrsPnlList.Sum(a => a.MW);
                    TotalMW = TotalMWCalculated / 2;
                    TotalDAMWCollect = TotalPNL / TotalMW;
                    winpercentageCalculated = IncompleteHrsPnlList.Where(a => a.DART > 0).Count();
                    WinText = winpercentageCalculated / IncompleteHrsPnlList.Count();
                    //TotalPNL;
                    PercentMW = TotalDollarClearedCalculated / TotalMW;
                    TotalRevenu = TotalRevenuCalculated;

                    PercentMW = TotalPNL / TotalMW;
                    TotalDAMWCollect = TotalDollarClearedCalculated / TotalMW;
            ...
            try
            {
                ...
                else
                {
                    ...
                    foreach (Bid bid in bidList)
                    {
                        ...
                        //if (pnl.Source == "BAFFIN_ALL" && DBAccess.GetNode(bid.Sink, bid.Market).NodeName == "OXY_PUN1" && pnl.SourceZone == "COASTAL" && DBAccess.GetNode(bid.Sink, bid.Market).Zone == "SOUTH" && pnl.HE == 17)
                        //{ }
                        //else
                        //    continue;
                        #region Uptos
                        ...
                        if (!double.IsNaN(rt))
                        {
                            ...
                            pnl.RTCongTot = rtCong * bid.MW;
                            pnl.RTLossTot = rtLoss * bid.MW;
                            pnl.Revenu = ((double)(pnl.RT * pnl.MW));//new line
                            if (pnl.Revenu == 0)
                            { }
                        }
                        if (!double.IsNaN(da) && !double.IsNaN(rt))
                        {
                            ...
                            //  pnl.Revenu = ((double)(pnl.RT * pnl.MW));
                        }
                ...
                if (IncomplteHrsChecked)
                {
                    ...
                    TotalDACong = pnlList.Sum(a => a.DACongTot);
                    TotalDALoss = pnlList.Sum(a => a.DALossTot);
                    TotalRevenu = pnlList.Sum(a => a.Revenu);
                ...
                else
                {
                    ...
                    TotalRTCong = tempList1.Sum(a => a.RTCongTot);
                    TotalRTLoss = tempList1.Sum(a => a.RTLossTot);
                    TotalRevenu = tempList1.Sum(a => a.Revenu);
                }
        ...
        private void ExportToCSVThreaded()
        {
            try
            {
                if (SelectedPortfolioList == null && SelectedMarket != "ERCOT PTP")
                {
                    Mouse.OverrideCursor = null;
                    return;
                }
                ...
                if (SelectedMarket == "ERCOT PTP")
                {
                    dialog.FileName = "ERCOT_PTP_Portfolio_" + DateTime.Today.ToString("yyyy-MM-dd") + ".csv";
                }
                    ...
                    if (dialog.FileName != "")
                    {
                        if (!SummaryChecked)
                        {
                            if (PNLList != null && PNLList.Count > 0)
                            {
                                ...
                                foreach (PropertyInfo item in PNLList[0].GetType().GetProperties())
                                {
                                    ...
                                    item.Name.ToUpper() == "DACONG" || item.Name.ToUpper() == "RTCONG" || item.Name.ToUpper() == "NETPNL" || item.Name.ToUpper() == "PAYCOLLECT"
                                    || item.Name.ToUpper() == "REVENU") /*|| item.Name.ToUpper() == "DALOSS" || item.Name.ToUpper() == "RTLOSS"*/
                                    {
                                ...
                                foreach (Pnl item in PNLList)
                                {
                                    ...
                                    propItem.Name.ToUpper() == "DACONG" || propItem.Name.ToUpper() == "RTCONG" || propItem.Name.ToUpper() == "NETPNL" || propItem.Name.ToUpper() == "PAYCOLLECT" || propItem.Name.ToUpper() == "REVENU")/*propItem.Name.ToUpper() == "DALOSS" || propItem.Name.ToUpper() == "RTLOSS" || */
                                        {
                        ...
                        else
                        {
                            if (PNLList != null && PNLList.Count > 0)
                            {
                                ...
                                foreach (PropertyInfo item in PNLList[0].GetType().GetProperties())
                                {
                                    if (item.Name.ToUpper() == "PORTFOLIONAME" || item.Name.ToUpper() == "MARKETDATE" || item.Name.ToUpper() == "MW" || item.Name.ToUpper() == "PNLVALUE" ||

                                    item.Name.ToUpper() == "NETPNL" || item.Name.ToUpper() == "PAYCOLLECT") /*|| item.Name.ToUpper() == "MW" || item.Name.ToUpper() == "DALOSS" || item.Name.ToUpper() == "RTLOSS"  item.Name.ToUpper() == "SOURCE" || item.Name.ToUpper() == "SINK" || || item.Name.ToUpper() == "DA" || item.Name.ToUpper() == "RT"  item.Name.ToUpper() == "SOURCEZONE" || item.Name.ToUpper() == "SINKZONE" ||  item.Name.ToUpper() == "DACONG" || item.Name.ToUpper() == "RTCONG" ||  item.Name.ToUpper() == "FEE" || item.Name.ToUpper() == "HE" item.Name.ToUpper() == "DART" || ||*/
                                    {
                                        builder.Append(item.Name.ToUpper() + ",");
                                    }
                                ...
                                foreach (Pnl item in PNLList)
                                {
                                    foreach (PropertyInfo propItem in item.GetType().GetProperties())
                                    {
                                        if (propItem.Name.ToUpper() == "PORTFOLIONAME" || propItem.Name.ToUpper() == "MARKETDATE" || propItem.Name.ToUpper() == "MW" || propItem.Name.ToUpper() == "PNLVALUE" || propItem.Name.ToUpper() == "NETPNL" || propItem.Name.ToUpper() == "PAYCOLLECT")/*propItem.Name.ToUpper() == "DALOSS" || propItem.Name.ToUpper() == "RTLOSS" || propItem.Name.ToUpper() == "SINK" ||
                                             propItem.Name.ToUpper() == "SOURCEZONE" || propItem.Name.ToUpper() == "SINKZONE" || propItem.Name.ToUpper() == "DA" || propItem.Name.ToUpper() == "RT" || propItem.Name.ToUpper() == "DART" || propItem.Name.ToUpper() == "FEE" ||
                                    propItem.Name.ToUpper() == "DACONG" || propItem.Name.ToUpper() == "RTCONG" || propItem.Name.ToUpper() == "NETPNL" || propItem.Name.ToUpper() == "PAYCOLLECT"*/
                                        {
                                            builder.Append(propItem.GetValue(item) + ",");
                                        }
                                    }
        ...
        public void SetMarket()
        {
            ...
            if (UserList.Contains(mUser))  // used for putting restrictions based on machine username 
            {
                ...
                if (!marketList.Contains("ERCOT PTP"))
                    marketList.Add("ERCOT PTP");
            ...
            try
            {
                ...
                if (!SummaryChecked)
                {
                    ...
                    if (isDALossChecked)
                    {
                        ...
                        var dataItemValues6 = new Collection<Axis>(); // use with non DateTime x axis

                        dataItemValues6 = new Collection<Axis>();
                        for (int i = 0; i < summaryValuesDA.Count; i++)
                        {
                            dataItemValues6.Add(new Axis() { X = i, Y = Math.Round(summaryValuesDALoss[i].PNL, 2), n = i + 1 });
                        }
                        lineSeries6 = new LineSeries()
                        {
                            ...
                            DataFieldX = "X",
                            DataFieldY = "Y",
                            ItemsSource = dataItemValues6,
                            TrackerFormatString = "HE: " + "{n:0}, " + "DALoss: " + "{Y:0}",
                            //TrackerFormatString = "{Hour:0}, {PNL:0.###}",
                            XAxisKey = "HourXAxis",
                            MarkerType = MarkerType.Diamond,
                            MarkerSize = 2,
                        ...
                        lineSeries6.Color = OxyColors.DarkRed;
                        lineSeries6.MarkerFill = OxyColors.DarkRed;
