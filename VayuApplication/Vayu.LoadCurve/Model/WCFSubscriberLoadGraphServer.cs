...
namespace Vayu.LoadCurve.Model
{
    ...
    /// 
    /// </summary>
    /// <seealso cref="WCFServerClientBase.WCFServerBase{Vayu.LoadCurve.Model.WCFSubscriberLMPServer,LoadServiceLibrary.ILoadGraph}" />
    /// <seealso cref="LoadServiceLibrary.ILoadGraphCallback" />
    class WCFSubscriberLoadGraphServer : WCFServerBase<WCFSubscriberLMPServer, ILoadGraph>, ILoadGraphCallback
    {
        ...
        /// 
        /// </summary>
        /// <seealso cref="WCFServerClientBase.WCFServerBase{Vayu.LoadCurve.Model.WCFSubscriberLMPServer,LoadServiceLibrary.ILoadGraph}.ProxySettingBase" />
    ...
    /// 
    /// </summary>
    /// <seealso cref="WCFServerClientBase.WCFServerBase{Vayu.LoadCurve.Model.WCFSubscriberLMPServer,NodePriceMonitorLibrary.INodePrice}" />
    ...
    public class WCFSubscriberLMPServer : WCFServerBase<WCFSubscriberLMPServer, INodePrice>, INodePriceCallback
    {
        ...
        {
            int proxyIndex = proxyToIndexHash[myProxy];
            //parentSender.SetConnectedStatusLMPServer(proxyIndex, bRemoteConnected);
        }
        /// <summary>
        /// Sets the subscribed status.
        /// </summary>
        ...
        /// 
        /// </summary>
        /// <seealso cref="WCFServerClientBase.WCFServerBase{Vayu.LoadCurve.Model.WCFSubscriberLMPServer,NodePriceMonitorLibrary.INodePrice}.ProxySettingBase" />
        public class ProxySetting : ProxySettingBase
        {
            /// <summary>
            /// The proxy
            ...
            //public ProxySetting(string myEndPointUrl, bool myEnabled, TextBox myEndPointUrlTextBox, CheckBox myEnabledCheckBox, Label myStatusLabel, Label myLblWebPrint, Label myLblAPIPrint)
            /// <summary>
            /// Initializes a new instance of the <see cref="ProxySetting"/> class.
            /// </summary>
            /// <param name="myEndPointUrl">My end point URL.</param>
