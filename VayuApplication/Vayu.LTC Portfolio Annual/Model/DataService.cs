...
namespace Vayu.LTC_PortfolioAnnual.Model
{
    public class DataService : IDataService
    {
        ...
        public void LoadDBCommands()
        {
            ...
            mSelectDistinctErcotCRRCommand.CommandText = "select CRRAuctionKey, CRRAuctionName from CRRAuction where auctionenddate >= convert(date,getdate()) and CRRAuctionType='Annual'";
