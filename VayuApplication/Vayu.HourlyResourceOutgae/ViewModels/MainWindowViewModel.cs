...
using Vayu.HourlyResourceOutgae.Model;

namespace Vayu.HourlyResourceOutgae.ViewModels
{
    public class MainWindowViewModel : BindableBase
    {
        ...
        private bool mNorthChecked;
        public bool NorthChecked
        {
            get
            {
                return mNorthChecked;
            }
            set
            {
                mNorthChecked = value; RaisePropertyChanged("NorthChecked");
                RefreshPlot();
            }
        }
        private bool mWestChecked;
        public bool WestChecked
        {
            ...
            {
                mWestChecked = value;
                RaisePropertyChanged("WestChecked");
                RefreshPlot();
            }
        }
        ...
        private bool mHoustonChecked;
        public bool HoustonChecked
        {
            get
            {
                return mHoustonChecked;
            }
            set
            {
                mHoustonChecked = value;
                RaisePropertyChanged("HoustonChecked");
                RefreshPlot();
            }
        }
        ...
        private bool mSouthChecked;
        public bool SouthChecked
        {
            get { return mSouthChecked; }
            set
            {
                mSouthChecked = value;
                RaisePropertyChanged("SouthChecked");
                RefreshPlot();
            }
        }
        ...
        private void FillColorList()
        {
            ...
            mOxyColorList.Add("South", OxyColors.Yellow);
            mOxyColorList.Add("North", OxyColors.DarkGreen);
            mOxyColorList.Add("West", OxyColors.Red);
            mOxyColorList.Add("Houston", OxyColors.Blue);
            mOxyColorList.Add("Total", OxyColors.Orange);
        }
        ...
        private void GetLoadData()
        {
            try
            {
                _dataService.GetHourlyOutageData((item, ex) =>
                {
                    mLoadList = item;
        ...
        private bool KeyChecked(string item)
        {
            switch (item.ToLower())
            {
                ...
                case "south": return SouthChecked;
                case "north": return NorthChecked;
                case "west": return WestChecked;
                case "houston": return HoustonChecked;
