...
{
    public class ExportToExcelNotification<T, U>
        where T : class
        where U : List<T>
    {
        #region Declaration
        ...
        private object[] CreateHeader(string Type)
        {
            ...
            {
                if (Type == "General Notification")
                {
                    if (headerInfo[n].Name.Equals("MarketDate") || headerInfo[n].Name.Equals("SubmittedDateTime") || headerInfo[n].Name.Equals("MRID") || headerInfo[n].Name.Equals("Status") || headerInfo[n].Name.Equals("Error") || headerInfo[n].Name.Equals("ErrorSeverity"))
                    {
                        continue;
                    }
                ...
                {
                    if (headerInfo[n].Name.Equals("Verb") || headerInfo[n].Name.Equals("Noun") || headerInfo[n].Name.Equals("Source") || headerInfo[n].Name.Equals("UserId") || headerInfo[n].Name.Equals("MessageId") || headerInfo[n].Name.Equals("QSE") ||
                        headerInfo[n].Name.Equals("ID") || headerInfo[n].Name.Equals("MessageType") || headerInfo[n].Name.Equals("Priority") || headerInfo[n].Name.Equals("MessageSource") || headerInfo[n].Name.Equals("IssuedTime") || headerInfo[n].Name.Equals("MessageSummary"))
                    {
                        continue;
                    }
                    objHeaders.Add(headerInfo[n].Name);
